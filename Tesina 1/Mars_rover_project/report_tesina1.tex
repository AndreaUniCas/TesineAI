...
\begin{figure}[h]
  ...
  \caption{Percorso trovato con algoritmo A* - scenario scientifico}
\end{figure} 
\begin{figure}[h]
  \centering
...
\begin{figure}[h]
  ...
  \caption{Percorso trovato con algoritmo A* - scenario solare}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{screen/scenario3/s3_risultati.png}
  \caption{Recap terminale - scenario comunicazione}
\end{figure}
\end{document}