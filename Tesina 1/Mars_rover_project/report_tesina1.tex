...
& \textbf{A*} & \textbf{BFS} \\
\midrule
Ottimalità  & \checkmark & \checkmark (con archi con costo unitario) \\
Completezza   & \checkmark & \checkmark \\
Percorso minimo (nodi espansi) & \texttimes & \checkmark \\
Integra vincoli nella ricerca & \checkmark & \texttimes \\
Complessità temporale         & $\mathcal{O}(V+E)$ & $\mathcal{O}(V+E)$ \\
\bottomrule
\end{tabular}
